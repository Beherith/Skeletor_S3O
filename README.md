...
4. Press the "Correctly rotate S3O" button, OR rotate the model around 90 degrees, so that Z is up, make sure its feet are on the ground, and apply rotation to the model.
